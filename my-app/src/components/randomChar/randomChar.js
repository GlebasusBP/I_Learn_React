...
import mjolnir from '../../sources/images/mjolnir.png';

class RandomeChar extends Component {
  constructor(props){
    super(props)
  ...
  render(){
    ...
    const content = !(loading || error) ? <RandomBlock char={char}/> : null;
